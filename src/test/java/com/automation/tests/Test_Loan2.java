...
public class Test_Loan2 {
    ...
    @Test
    public void Test_EducationLoanCalculation_3() throws InterruptedException {
    ...
    @Test
    public void Test_EducationLoanCalculation_4() throws InterruptedException {
        HomePage homePage = new HomePage(driver);
        homePage.NavigateToEducationLoanPage();
